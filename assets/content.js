export const AUN_CONTENT = {
  brand: {
    ...
    label: "商談向けエディトリアルサイト",
    tagline: "静けさの輪郭を纏う、東京発の独立系レーベル。",
    summary:
      "AUN は、素材の余韻と身体の間に生まれる空気を設計するための独立系ファッションレーベルです。取扱先、スタイリスト、エディターが短時間で判断できるよう、今季の輪郭と協業導線を整理しています。",
    themeTitle: "静かな残響 / 第1章",
    seasonHeading: "低いコントラストと正確な構造、歩行時の揺れで見せる今季の構成。",
    seasonCopy:
      "今季は、輪郭を強く押し出すのではなく、歩いたときにだけ見える陰影と余白に集中しています。販売前提の説明ではなく、取扱判断に必要なムード、価格帯の空気、制作姿勢を一度で掴めるように編成しています。",
    audience:
  ...
  home: {
    ...
    reasons: [
      ...
      {
        title: "編集として読みやすい",
        text: "見せたい印象、説明すべき条件、共有すべき導線を分け、商談前の読み物として機能させます。",
      },
    ],
    representativeLook: {
      title: "代表ルック / ロングバイアスコートを軸にした構成",
      summary:
        "肩線を固定せず、歩行時の揺れで輪郭が変わるロングコートを軸にした代表ルックです。AUN の商談では、この一体で素材感、価格帯、スタイリング適性をまとめて伝える想定です。",
      image: {
        src: "./assets/generated/look-02.png",
        alt: "AUN の代表ルックを抽象化した縦長ビジュアル",
        caption: "代表ルック / 商談の起点になるシルエット",
      },
      details: [
  ...
  collections: [
    {
      ...
      noteTitle: "補足ノート / 今季主力",
      note:
        "展示会や商談では、静かな見た目よりも、着用時の揺れと層の重なりで印象が変わる点を重視して共有する想定です。写真は抑制的でも、接客では素材差と構造差が効く構成です。",
      looks: [
        {
          id: "look-01",
          name: "ルック 01",
        ...
        },
        {
          ...
          text: "ライン全体の温度を決めるロングコート。商談時の主軸ピースとして想定しています。",
      ...
      selectedPieces: [
        {
          name: "主力バイアスコート",
          descriptor: "流れる前端と低い重心を持つ主力アウター。展示会のアイキャッチ兼、商談起点。",
        },
        {
          name: "ヴェールシャツ",
  ...
  about: {
    intro:
      "AUN は、声量の大きいブランドではありません。代わりに、編集の余白、触れたときの納得感、誰の文脈にも寄り過ぎない輪郭を整えることに集中しています。",
    principles: [
      {
      title: "装飾より先にかたちを整える",
      ...
      title: "商材でありながら声を荒げない",
        text: "商材として成立することを前提にしつつ、見た瞬間の静かな緊張感を失わないようにします。",
      },
      {
      title: "読み順まで含めて整える",
        text: "説明の順番まで含めてデザインし、買い手が短時間で判断できる情報密度に調整します。",
      },
    ],
    story: {
      title: "売場、撮影、会話のあいだを行き来できる小さなライン。",
      copy:
        "東京を基点に、京都の縫製・仕上げパートナーと連携しながら少量で制作する想定です。大量生産の代わりに、スタイリングの自由度とラックでの編集しやすさを両立させることを優先しています。",
      image: {
